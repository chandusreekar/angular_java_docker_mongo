...
public class UserAuthenticationController {
	...
	public ResponseEntity<?> registerUser(@RequestBody User user) throws UserAlreadyExistsException {
		...
		try {
			System.out.println("inside try block of user authentication registration");
	...
	public ResponseEntity<?> loginUser(@RequestBody User user) throws UserNotFoundException {
		...
		try {
			...
			if (userObj.getUserId().equals(user.getUserId())
					&& userObj.getUserPassword().equals(user.getUserPassword())) {
				authenticationtoken = getToken(userObj.getFirstName(), userObj.getUserPassword());
				System.out.println("user auth token is===========> "+authenticationtoken);
				System.out.println("useris and password is"+user.getUserId()+"=========="+user.getUserPassword());
...
// Generate JWT token
	...
	@GetMapping("/hello")
	public String hello() {
		return "inside userauthenticationservice";
	}
